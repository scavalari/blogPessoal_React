...
function Home() {
    return (
        <>
            <Grid className='back' container direction="row" justifyContent="center" alignItems="center" style={{ backgroundColor: "#a88081" }}>
                ...
                <Grid item xs={6} >
                    <img src={MeuAvatargt} alt="" width="500px" height="500px" />
                </Grid>
